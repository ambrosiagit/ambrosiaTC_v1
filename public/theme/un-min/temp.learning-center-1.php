...
<hr class="hr-shadow-aaa">
    ...
    <div class="row" id="types-of-addiction">
        <div class="col-lg-10 col-lg-offset-1">
            <div class="row">
                <div class="col-md-4 v_1 text-center">
                    <h4 class="common_h4"><?php echo $block_three_title; ?></h4>
                    <div class="rotator">
                        <div class="rotator-inner">
                            <i class="fa fa-backward off"></i>
                            <?php
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                        ...
                                        <div class="profile-img" style="background-image: url('<?php echo $thumb_url_val; ?>');"></div>
                                    </a>
                                </div>
                                <div class="col-xs-9">
                                    <div class="link-text">
                                        ...
                                        ?>
                                        <b><a href="<?php the_permalink(); ?>"><?php echo strip_tags(wp_trim_words( $the_title, 10, '...' ));?></a></b><br>
                                        <a href="<?php the_permalink(); ?>"><?php echo strip_tags(wp_trim_words( $the_content, 50, '...' ));?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-8 v_1_1" id="sidebar-2">
                    <div class="row">
                        <div class="post-body">
                            <div class="row" id="post-controls">
                                <div class="col-xs-6">
                                    <h4  class="common_h4">Latest Articles</h4>
                                </div>
                                <div class="col-xs-6">
                                    <i class="fa fa-forward "></i>
                                    <i class="fa fa-backward off"></i>
